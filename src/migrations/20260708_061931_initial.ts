...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'kh', 'cn');
  CREATE TYPE "public"."enum_users_roles" AS ENUM('super-admin', 'tenant-admin', 'editor');
  ...
  ALTER TABLE "doctors_specialty" ADD CONSTRAINT "doctors_specialty_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."doctors"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "services_source_id_idx" ON "services" USING btree ("source_id");
  CREATE INDEX "services_slug_idx" ON "services" USING btree ("slug");
  CREATE INDEX "services_updated_at_idx" ON "services" USING btree ("updated_at");
  CREATE INDEX "services_created_at_idx" ON "services" USING btree ("created_at");
  CREATE UNIQUE INDEX "services_locales_locale_parent_id_unique" ON "services_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "doctors_specialty_order_idx" ON "doctors_specialty" USING btree ("_order");
  CREATE INDEX "doctors_specialty_parent_id_idx" ON "doctors_specialty" USING btree ("_parent_id");
  CREATE INDEX "doctors_specialty_locale_idx" ON "doctors_specialty" USING btree ("_locale");
  ...
  CREATE INDEX "doctors_source_id_idx" ON "doctors" USING btree ("source_id");
  CREATE INDEX "doctors_department_idx" ON "doctors" USING btree ("department");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "doctors_specialty" CASCADE;
